...
function NavBar() {
  ...
  return (
    ...
    transition={{duration:0.5}} className='w-full max-w-6xl  h-20 flex items-center  relative justify-between px-8 py-4 bg-white rounded-[24px] shadow-md border border-gray-200'>
   <div className='flex items-center gap-3 cursor-pointer'>
    <div className='bg-black text-white p-2 rounded-lg'>
    <BsRobot size={18}/>
    </div>
    <h1 className='font-semibold md:block  text-lg '>InterviewX.Ai</h1>
   </div>
    ...
    <div className='relative'>
      ...
      {showUserPopup && (
        <div className='absolute right-0 mt-3 w-48 bg-white shadow-xl border border-gray-200 rounded-xl p-5 z-50'>
          <p className='text-md  text-blue-600 font-medium  mb-2 '> Signed in as <span className='font-semibold'>{userData?.name}</span></p>
