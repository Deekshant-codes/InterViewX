          ...
          <div className='space-y-6'>
            <div className='relative'>
              ...
              <input
                ...
                className='w-full pl-12 pr-4 py-3 border border-gray-200 rounded-xl focus:ring-2 focus:ring-green-500 outline-none transition duration-300'
              />
            </div>
            ...
            <select
              ...
              className='w-full py-3 px-4 border border-gray-200 rounded-xl focus:ring-2 focus:ring-green-500 outline-none transition duration-300'
            >
            ...
            {!analysisDone && (
              <motion.div
                ...
                className='border-2 border-dashed border-gray-300 rounded-xl text-center cursor-pointer hover:border-green-500 hover:bg-green-50 transition duration-300'
              >
                ...
                {resumeFile && (
                  <motion.button
                    ...
                    className='mt-4 bg-green-900 text-white py-2 px-5 rounded-xl hover:bg-gray-800 transition duration-300'
                  >
            ...
            onClick={handleStart}
              ...
              className='w-full mt-6 bg-green-600 disabled:bg-gray-600 text-white py-3 rounded-full text-lg font-semibold shadow-md hover:bg-green-700 transition duration-300'
            >
